function predictions = nFoldCrossValidationRP(examples, answers, n, layerSize, numLayers, valPc, delt_inc, delt_dec)
...
%predictions and returns them with expected values
  ...
  for i = 1:n
    ...
    net = createNetworkRP(layerSize, numLayers, valPc, delt_inc, delt_dec, x2, y2);
