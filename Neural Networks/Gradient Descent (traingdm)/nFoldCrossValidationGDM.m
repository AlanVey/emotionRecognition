function predictions = nFoldCrossValidationGDM(examples, answers, n, layerSize, numLayers, valPc, lr, mc)
...
%predictions and returns them with expected values
  ...
  for i = 1:n
    ...
    net = createNetworkGDM(layerSize, numLayers, valPc, lr, mc, x2, y2);
